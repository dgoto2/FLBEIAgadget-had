# FLBEIA-Gadget MSE framework with the simple haddock Gadget example model (J. Begley) as operating model and without assessment
# updated 11-jun-2020
...
## Save FLBEIA input objects
 save(biols, SRs, BDs, oneGDGT, had.params, fleets, covars, oneIndAge, advice, main.ctrl, biols.ctrl, fleets.ctrl, 
      covars.ctrl, advice.ctrl, obs.ctrl.age, assess.ctrl, file="input_flbeia-gadget_age_4s_noassss.RData")
